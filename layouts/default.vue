<template>
  <div class="font-sans tw-flex tw-flex-col">
    <header>
      <nav
        ...
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/">
            <h1 class="tw-text-2xl tw-text-blue-400">
              ms-implant.
            </h1>
          </nuxt-link>
          <nuxt-link v-else to="/">
        ...
        <ul
          ...
          <li>
            <nuxt-link to="/portfolio" class="tw-text-black hover:tw-text-blue-300 tw-text-xl">About Us</nuxt-link>
          </li>
          <li>
      ...
      <div
        ...
        <div class="tw-mb-8 lg:tw-mb-0">
          <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-2">
            <span>Copyright {{ new Date().getFullYear() }} msimplant </span>
            <span class="tw-text-center">Designed by Serge Tassiga</span>
          </div>
        </div>
        <ul class="tw-flex tw-items-center tw-space-x-8">
          <li>
            <a href="mailto:s.tassiga@alustudent.com" class="tw-text-white hover:tw-text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/STassiga" target="_blank" class="tw-text-white hover:tw-text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/__iamsergeo/" target="_blank"
              class="tw-text-white hover:tw-text-gray-400">
  ...
  export default {
    ...
    mounted() {
      ...
      (function () {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/6452435931ebfa0fe7fbba8f/1gvgle6b6';
        s1.charset = 'UTF-8';
