<template>
  <div class="">
    ...
    <div
      class="tw-bg-gray-200 tw-shadow-2xl lg:tw-rounded-md lg:tw-mx-8 tw-transform tw--translate-y-58 tw-bottom-0 tw-left-0 tw-px-8 tw-py-12">
      <div class="lg:tw-flex lg:tw-flex-row sm:tw-flex sm:tw-flex-col lg:tw-justify-betwen lg:tw-gap-8">
        ...
        <div class="tw-text-lg sm:tw-text-lg lg:tw-w-2/3">
          ...
          <form class="tw-mb-8" v-on:submit="sendMessage">
