...
<h1
            class="tw-mt-12 tw-text-xl tw-text-center lg:tw-text-2xl tw-font-bold tw-uppercase md:tw-ml-8 md:tw-ml-20 md:tw-mb-20 tw-font-extrabold tw-text-blue-600">
            News
          </h1>

      <v-row class="tw-p-6 tw-pt-3">
